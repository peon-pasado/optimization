...
struct info {
    ...
    int Tmin; //minimum time
    int Tmax; //maximum time
    // Flag para usar la implementación mejorada de stage3 basada en Tanaka
    bool use_tanaka_stage3 = false;
};
...
SublGraph* subl_graph_copy;
lr2m_mod_t* lr2m_mod;
_fixed_t* fixed_jobs;
_fixed_t* fixed_jobs_copy;